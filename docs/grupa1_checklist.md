...
| Redukcja wymiaru (PCA / UMAP / PaCMAP) | [src/dim_reduction.py](../src/dim_reduction.py), wykres `dim_reduction.vl.json` |
| Wizualizacja 2D | Scatter PCA / UMAP / PaCMAP + klastry na PC1-PC2 |
